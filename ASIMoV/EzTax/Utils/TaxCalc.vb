Public Class TaxCalc
    ...
    Public Structure TaxInformation
        ...
        Public Sub New(ExtraIncome As Long, NewpondIncome As Long, UrbiaIncome As Long, ParadisusIncome As Long, LaertesIncome As Long, NorthOstenIncome As Long, SouthOstenIncome As Long, Category As Integer)
            ...
            If Category = 2 Then
                Federal = New TaxCalcResult(New TaxBracket("N/A", 0, 0, 0), 0)
                Newpond = New TaxCalcResult(New TaxBracket("N/A", 0, 0, 0), 0)
                Urbia = New TaxCalcResult(New TaxBracket("N/A", 0, 0, 0), 0)
                Paradisus = New TaxCalcResult(New TaxBracket("N/A", 0, 0, 0), 0)
                Laertes = New TaxCalcResult(New TaxBracket("N/A", 0, 0, 0), 0)
                NorthOsten = New TaxCalcResult(New TaxBracket("N/A", 0, 0, 0), 0)
                SouthOsten = New TaxCalcResult(New TaxBracket("N/A", 0, 0, 0), 0)
                TotalTax = 0
                Return
            End If
