...
Public Class CoreCommands
    ...
    ''' <returns>HasUMSNB,UMSNBBalance,HasGBANK,GBANKBalance,HasRIVER,RIVERBalance,UserName,notifs</returns>
    Public Shared Function INFO(UserID As String) As String
